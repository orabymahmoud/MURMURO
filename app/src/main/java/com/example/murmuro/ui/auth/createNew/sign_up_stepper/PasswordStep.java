...
public class PasswordStep extends Step<String> {
    ...
    protected View createStepContentLayout() {
        ...
        PasswordView.setHint("Your Email");
        PasswordView.setTextColor(R.color.colorOnSecondary);
        PasswordView.setInputType(InputType.TYPE_NUMBER_VARIATION_PASSWORD);
    ...
    protected IsDataValid isStepDataValid(String stepData) {
        ...
        boolean isNameValid = stepData.matches(pattern);
        String errorMessage = !isNameValid ? "Passord EX: aaZZa44@" : "";
